defmodule Butler.ReservationTest do
  ...
  setup do
    ...
    barcode = Repo.insert! %Barcode{table_id: table.id}

    %{
      valid_attrs: %{notes: "some notes", shinkansen: true, size: 2, staff: true, time_in: "2010-04-17 14:00:00.000000Z", time_out: "2010-04-17 14:00:00.000000Z", table_number: table.table_number, maid_id: maid.id, barcode_id: barcode.id},
